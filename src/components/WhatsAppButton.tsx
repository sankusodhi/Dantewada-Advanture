...
const WhatsAppButton: React.FC = () => {
  const phoneNumber = '+916268409259'; // Updated to use the specified number
  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 175.216 175.552" className="w-8 h-8 fill-blue">
